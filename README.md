...
Relational Databases are used to store information in table, SQL is used to CRUD that data.

2. Why do tables need a Primary Key?

All records need a unique identifier that can be reference from within and without the context of that table.
...
Primary Keys and Foreign Keys in both tables referencing eachother
